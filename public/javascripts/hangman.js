...
function check(nr) {
  ...
  if (password == password1)
    document.getElementById("alphabet").innerHTML = '<br/><br/><br/>' + "Good job, that is it!: " + '<br/><br/><br/>' + "\"" + password + "\"" + '<br/><br/><br/><span class="reset" onclick="location.reload()">ONE MORE TIME ? </span>';

  // LOST
  if (fails >= 9)
  document.getElementById("alphabet").innerHTML = '<br/><br/><br/>' + "Sorry.. but YOU ARE A LOOSER!! ^^ " + '<br/><br/><br/>' + "The password was: \"" + password + "\"" + '<br/><br/><br/><span class="reset" onclick="location.reload()">ONE MORE TIME ? </span>';
